package md57c0e11f1e4b97fd6599d9263beb9cf8e;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FingerAuth.FingerprintHandler, FingerAuth", FingerprintHandler.class, __md_methods);
	}
	...
	public FingerprintHandler ()
	{
		...
		if (getClass () == FingerprintHandler.class)
			mono.android.TypeManager.Activate ("FingerAuth.FingerprintHandler, FingerAuth", "", this, new java.lang.Object[] {  });
	}
	...
	public FingerprintHandler (android.content.Context p0)
	{
		super ();
		if (getClass () == FingerprintHandler.class)
			mono.android.TypeManager.Activate ("FingerAuth.FingerprintHandler, FingerAuth", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
